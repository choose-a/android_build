...
if __name__ == '__main__':
    # Default to Choose Gerrit
    default_gerrit = 'http://review.choose-a.name'

    parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter, description=textwrap.dedent('''\
        repopick.py is a utility to simplify the process of cherry picking
        patches from ChooseROM's Gerrit instance (or any gerrit instance of your choosing)
    ...
    default_revision = xml_root.findall('.//*[@name="choose"]')[0].get('revision').split('/')[-1]

...
- crbremote: Add git remote for matching ChooseBeta repository.
- crremote: Add gerrit remote for matching Choose repository.
...
function crbremote()
{
    ...
    PROJECT=`pwd -P | sed s#$ANDROID_BUILD_TOP/##g`
    PFX="android_$(echo $PROJECT | sed 's/\//_/g')"
    git remote add crb git@github.com:ChooseBeta/$PFX
...
function addcompletions()
{
    ...
    local completion_files=(
      ...
      vendor/choose-a/bash_completion
    )
